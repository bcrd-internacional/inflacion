...
palette_names <- read_html(url) %>%
  html_elements('.grid div div .w-16 div div') %>%
  html_text()
  
colors_grid <- read_html(url) %>%
  html_elements('.grid div div .min-w-0') 
...
palettes <- setNames(palettes, palette_names)
